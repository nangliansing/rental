...
export const validateEnvironment = (env = process.env) => {
  ...
  const config = {
    ...
    queue: {
      ...
      workerDrainDelaySeconds: parseInteger(
        env,
        "QUEUE_WORKER_DRAIN_DELAY_SECONDS",
        30,
        5,
        120,
        issues,
      ),
      workerRedisCooldownInitialMs: parseInteger(
        env,
        "QUEUE_WORKER_REDIS_COOLDOWN_INITIAL_MS",
        1_000,
        250,
        60_000,
        issues,
      ),
      workerRedisCooldownMaxMs: parseInteger(
        env,
        "QUEUE_WORKER_REDIS_COOLDOWN_MAX_MS",
        60_000,
        1_000,
        300_000,
        issues,
