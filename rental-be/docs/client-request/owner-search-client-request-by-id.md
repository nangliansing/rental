# Get My Client Request By Id

Fetch a single non-deleted client request owned by the authenticated user.

## Endpoint

```http
GET /api/v1/client-requests/:clientRequestId
```

Full local URL:

```http
GET http://localhost:3000/api/v1/client-requests/6a70f2002c0e518d5b689200
```
...
- the client request is soft-deleted
