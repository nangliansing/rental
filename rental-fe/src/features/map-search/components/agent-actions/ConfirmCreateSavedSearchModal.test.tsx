...
vi.mock("@/features/saved-search/api", () => ({
  SAVED_SEARCH_DESCRIPTION_MAX_LENGTH: 2_000,
  SAVED_SEARCH_NAME_MAX_LENGTH: 120,
...
vi.mock(
  "@/features/saved-search/hooks/useHydrateSavedSearchSelectedListers",
  () => ({
    useHydrateSavedSearchSelectedListers: () => undefined,
  }),
)
...
describe("ConfirmCreateSavedSearchModal", () => {
  beforeEach(() => {
    mutate.mockReset()
    reset.mockReset()
    toast.mockReset()
