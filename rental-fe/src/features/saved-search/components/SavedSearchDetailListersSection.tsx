...
type SavedSearchDetailListersSectionProps = {
...
/** Read-only preferred listers for the saved-search detail pane. */
export function SavedSearchDetailListersSection({
  filters,
}: SavedSearchDetailListersSectionProps) {
