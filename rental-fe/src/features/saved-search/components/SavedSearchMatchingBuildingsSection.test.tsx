...
vi.mock(
  "@/features/saved-search/api/useSavedSearchMatchingBuildings",
  () => ({
    useSavedSearchMatchingBuildings: () => matchingBuildingsState,
  }),
)
...
describe("SavedSearchMatchingBuildingsSection", () => {
  beforeEach(() => {
  ...
  it("shows saved-search empty copy instead of map-search placeholder", () => {
