...
import { useSavedSearchMatchingBuildings } from "@/features/saved-search/api/useSavedSearchMatchingBuildings"
...
type SavedSearchMatchingBuildingsSectionProps = {
...
export function SavedSearchMatchingBuildingsSection({
  geoSearch,
  filters,
  scrollRootRef,
}: SavedSearchMatchingBuildingsSectionProps) {
  const {
    buildings,
    status,
    canSearch,
    ...
    fetchNextPage,
    refetchActiveSearch,
  } = useSavedSearchMatchingBuildings({
    geoSearch,
    filters,
  })
