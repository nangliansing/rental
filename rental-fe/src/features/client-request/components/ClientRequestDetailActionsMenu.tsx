...
type ClientRequestDetailActionsMenuProps = {
...
export function ClientRequestDetailActionsMenu({
  status,
  disabled = false,
  onEditRequest,
  onCloseRequest,
  onDeleteRequest,
}: ClientRequestDetailActionsMenuProps) {
    ...
    <DropdownMenu.Root open={open} onOpenChange={setOpen}>
      <DropdownMenu.Trigger asChild>
        <button
          ...
          disabled={disabled}
          data-testid="client-request-detail-actions"
        >
