...
type ClientRequestDetailFiltersSectionProps = {
...
/** Collapsible read-only preference chips for the client-request detail pane. */
export function ClientRequestDetailFiltersSection({
  filters,
}: ClientRequestDetailFiltersSectionProps) {
