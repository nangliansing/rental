...
type ClientRequestDetailCollapsibleSectionProps = {
  title: string
...
/** Shared disclosure chrome for client-request detail sections. */
export function ClientRequestDetailCollapsibleSection({
  title,
  ariaLabel = title,
  defaultOpen = true,
  ...
  children,
  className,
}: ClientRequestDetailCollapsibleSectionProps) {
