...
import { formatClientRequestGeoPreview } from "./formatClientRequestListMeta"

export function getClientRequestStatusBadgeClassName(
...
export function clientRequestGeoSearchToReadOnlyMapGeo(
...
export function formatClientRequestGeoSummary(geoSearch: ClientRequestGeoSearch): {
  title: string
  detail: string
} {
  const placeLabel = formatClientRequestGeoPreview(geoSearch)
