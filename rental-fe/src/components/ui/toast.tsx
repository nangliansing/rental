...
const toastVariantClasses: Record<ToastVariant, string> = {
  ...
  "success-pill":
    "w-auto max-w-[min(calc(100vw-2rem),28rem)] rounded-full border-2 border-blue-600 bg-blue-600/15 px-4 py-2 text-blue-700 shadow-none backdrop-blur-sm",
}
...
const toastTitleVariantClasses: Record<ToastVariant, string> = {
  ...
  "success-pill":
    "min-w-0 flex-1 truncate text-sm font-semibold leading-5 text-blue-700",
}
...
const toastCloseVariantClasses: Record<ToastVariant, string> = {
  ...
  "success-pill":
    "static shrink-0 rounded-full p-1 text-blue-700 opacity-100 hover:bg-blue-600/15 hover:text-blue-800 focus-visible:ring-2 focus-visible:ring-blue-600/40 focus-visible:outline-none",
}
